<?php 
  $edit=$mysqli->query("select * from produk where id_produk='$_GET[id_produk]'");
  $e=mysqli_fetch_array($edit);
?>

<form name="form_produk" action="index.php?page=update" method="post" enctype="multipart/form-data">
